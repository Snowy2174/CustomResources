...
public class JsonLocationUtil implements JsonDeserializer<Location>, JsonSerializer<Location> {

    public static final JsonLocationUtil INSTANCE = new JsonLocationUtil();
